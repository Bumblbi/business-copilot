      ...
      <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-green-100 p-8 max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {apiInfo.data.features.map((feature, index) => (
                  <div key={index} className="flex items-start space-x-4 p-4 rounded-lg bg-green-50 border border-green-100 hover:border-green-300 transition-colors duration-200">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-green-100 hover:shadow-md transition-shadow duration-200">
              <div className="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center mb-4 mx-auto">
                <span className="text-white text-lg font-bold">👥</span>
              </div>
              <h3 className="text-lg font-semibold text-green-800 mb-2 text-center">Регистрация</h3>
              <p className="text-green-600 text-center mb-4">Создайте аккаунт для доступа ко всем функциям</p>
              <Link 
                to="/register" 
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-green-100 hover:shadow-md transition-shadow duration-200">
              ...
              <h3 className="text-lg font-semibold text-green-800 mb-2 text-center">AI Чат</h3>
              <p className="text-green-600 text-center mb-4">Пообщайтесь с нашим интеллектуальным помощником</p>
              <Link 
                to="/chat" 
